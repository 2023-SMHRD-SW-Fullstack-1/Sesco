...
function Survey({ kid, user_id }) {
    ...
    const submitResult = async () => {
        ...
        try {
            const response = await axios.post('http://172.30.1.39:8081/sesco/survey/saveresult', resultsData, config);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.post('http://172.30.1.39:8081/sesco/survey/agechecklist', {
                    hsv_seq: kidMonth,
                });
